...
export const invoices = pgTable(
  "invoices",
  {
    ...
    minAllowedEquityPercentage: numeric("min_allowed_equity_percentage", { precision: 5, scale: 2 }),
    maxAllowedEquityPercentage: numeric("max_allowed_equity_percentage", { precision: 5, scale: 2 }),
...
export const companyContractors = pgTable(
  "company_contractors",
  {
    ...
    equityPercentage: numeric("equity_percentage", { precision: 5, scale: 2 }).default("0").notNull(),
  },
  (table) => [
